...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE, error = TRUE, dpi = 600)
...
if (!dir.exists("/data/.R/lib/easyGgplot2")) {
    withr::with_libpaths(new="/data/.R/lib", devtools::install_github("kassambara/easyGgplot2") )
}
library(easyGgplot2)
